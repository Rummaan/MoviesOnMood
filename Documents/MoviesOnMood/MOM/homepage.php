...
<body>
  ...
  <div class="out">
    <p align="center"><a class="tp" href="moodtemp.html" >Try our MOOD TEMPLATE for a better experience</a></p>
    <h2>Trending:</h2>
  </div>
    <div align="center" class="grid">
    <?php
      $img=mysqli_query($conn,"SELECT * FROM general WHERE id<5");
    ...
    <div class="out">
     ...
     <div align="center" class="grid">
    <?php
      $img=mysqli_query($conn,"SELECT * FROM general WHERE id BETWEEN 5 AND 8");
      while($rows=mysqli_fetch_assoc($img))
      {
        $id=$rows['id'];
        $poster=$rows['poster1'];
