...
if($_SERVER["REQUEST_METHOD"]=="POST"){		
		$mid=$_POST["list"];	
		$a=mysqli_query($conn,"DELETE FROM list WHERE mid=$mid");
...
<body>
    ...
    <a class="b" href="log.php">Logout</a>
		...
		<div align="center" class="main fi" >
			<form action="listk.php?id=<?php echo $id;?>" method="post">
			<td>

			<h3>Enter Movie id from the list which you want to Remove:</h3>
